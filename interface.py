...
class MainWindow(QWidget):
    ...
    def swans_recognition(self):
        ...
        with open('Swans.csv', 'w', newline='') as csvfile:
            ...
            dlg_complite.setText(f"Обработано {total_file} файлов! Обнарежены лебеди: Малый {total_litle}, Кликун {total_klikun}, Шипун {total_shipun}. Результаты сохранены в файл Swans.csv")
